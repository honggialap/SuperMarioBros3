...
void CVenusFireball::HandleAction(float elapsedMs)
{
}

void CVenusFireball::StandBy(float elapsedMs)
{
}

void CVenusFireball::Entry(float elapsedMs)
{
}

void CVenusFireball::Progress(float elapsedMs)
{
}

void CVenusFireball::Recover(float elapsedMs)
{
}
