	...
	if (!_blink)
	{
		...
		case CMario::EAction::RUN:
			...
			case CMario::EPower::SMALL:
			{
				if (_fly)
				{
					if (_left) _animations[ANI_MARIO_S_RUN_FAST_LEFT]->Render(_x, _y);
					else	   _animations[ANI_MARIO_S_RUN_FAST_RIGHT]->Render(_x, _y);
				}
				else if (_hold)
				{
				...
				{
					if (_left) _animations[ANI_MARIO_S_RUN_SLOW_LEFT]->Render(_x, _y);
					else	   _animations[ANI_MARIO_S_RUN_SLOW_RIGHT]->Render(_x, _y);
				}
			}
			break;
			case CMario::EPower::LARGE:
			{
				if (_fly)
				{
					if (_left) _animations[ANI_MARIO_L_RUN_FAST_LEFT]->Render(_x, _y);
					else	   _animations[ANI_MARIO_L_RUN_FAST_RIGHT]->Render(_x, _y);
				}
				else if (_hold)
				{
				...
				{
					if (_left) _animations[ANI_MARIO_L_RUN_SLOW_LEFT]->Render(_x, _y);
					else	   _animations[ANI_MARIO_L_RUN_SLOW_RIGHT]->Render(_x, _y);
				}
			}
			break;
			case CMario::EPower::RACCOON:
			{
				if (_fly)
				{
					if (_left) _animations[ANI_MARIO_R_RUN_FAST_LEFT]->Render(_x, _y);
					else	   _animations[ANI_MARIO_R_RUN_FAST_RIGHT]->Render(_x, _y);
				}
				else if (_hold)
				{
				...
				{
					if (_left) _animations[ANI_MARIO_R_RUN_SLOW_LEFT]->Render(_x, _y);
					else	   _animations[ANI_MARIO_R_RUN_SLOW_RIGHT]->Render(_x, _y);
				}
			}
			break;
			}
...
void CMario::Run(float elapsedMs)
{
	...
	case CMario::EActionStage::START:
	{
		/* animation */
		{
			...
			_animations[ANI_MARIO_S_RUN_SLOW_LEFT]->Play(true);
			_animations[ANI_MARIO_S_RUN_SLOW_RIGHT]->Play(true);
			_animations[ANI_MARIO_L_RUN_SLOW_LEFT]->Play(true);
			_animations[ANI_MARIO_L_RUN_SLOW_RIGHT]->Play(true);
			_animations[ANI_MARIO_R_RUN_SLOW_LEFT]->Play(true);
			_animations[ANI_MARIO_R_RUN_SLOW_RIGHT]->Play(true);
		
			_animations[ANI_MARIO_S_RUN_FAST_LEFT]->Play(true);
			_animations[ANI_MARIO_S_RUN_FAST_RIGHT]->Play(true);
			_animations[ANI_MARIO_L_RUN_FAST_LEFT]->Play(true);
			_animations[ANI_MARIO_L_RUN_FAST_RIGHT]->Play(true);
			_animations[ANI_MARIO_R_RUN_FAST_LEFT]->Play(true);
			_animations[ANI_MARIO_R_RUN_FAST_RIGHT]->Play(true);
		}
	}
	_actionStage = EActionStage::PROGRESS;
	break;
	...
	case CMario::EActionStage::PROGRESS:
	{
		/* animation */
		{
			...
			_animations[ANI_MARIO_S_RUN_SLOW_LEFT]->Update(elapsedMs);
			_animations[ANI_MARIO_S_RUN_SLOW_RIGHT]->Update(elapsedMs);
			_animations[ANI_MARIO_L_RUN_SLOW_LEFT]->Update(elapsedMs);
			_animations[ANI_MARIO_L_RUN_SLOW_RIGHT]->Update(elapsedMs);
			_animations[ANI_MARIO_R_RUN_SLOW_LEFT]->Update(elapsedMs);
			_animations[ANI_MARIO_R_RUN_SLOW_RIGHT]->Update(elapsedMs);

			_animations[ANI_MARIO_S_RUN_FAST_LEFT]->Update(elapsedMs);
			_animations[ANI_MARIO_S_RUN_FAST_RIGHT]->Update(elapsedMs);
			_animations[ANI_MARIO_L_RUN_FAST_LEFT]->Update(elapsedMs);
			_animations[ANI_MARIO_L_RUN_FAST_RIGHT]->Update(elapsedMs);
			_animations[ANI_MARIO_R_RUN_FAST_LEFT]->Update(elapsedMs);
			_animations[ANI_MARIO_R_RUN_FAST_RIGHT]->Update(elapsedMs);
		}
	...
	case CMario::EActionStage::EXIT:
	{
		/* animation */
		{
			...
			_animations[ANI_MARIO_S_RUN_SLOW_LEFT]->Stop();
			_animations[ANI_MARIO_S_RUN_SLOW_RIGHT]->Stop();
			_animations[ANI_MARIO_L_RUN_SLOW_LEFT]->Stop();
			_animations[ANI_MARIO_L_RUN_SLOW_RIGHT]->Stop();
			_animations[ANI_MARIO_R_RUN_SLOW_LEFT]->Stop();
			_animations[ANI_MARIO_R_RUN_SLOW_RIGHT]->Stop();

			_animations[ANI_MARIO_S_RUN_FAST_LEFT]->Stop();
			_animations[ANI_MARIO_S_RUN_FAST_RIGHT]->Stop();
			_animations[ANI_MARIO_L_RUN_FAST_LEFT]->Stop();
			_animations[ANI_MARIO_L_RUN_FAST_RIGHT]->Stop();
			_animations[ANI_MARIO_R_RUN_FAST_LEFT]->Stop();
			_animations[ANI_MARIO_R_RUN_FAST_RIGHT]->Stop();
		}
