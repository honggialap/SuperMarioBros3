...
void CWorldController::Load()
{
	CGameObject::Load();
}

void CWorldController::Start()
{
	_start = true;
	SetCamera(0);
}

void CWorldController::Update(float elapsedMs)
{
	if (!_start) Start();
...
void CWorldController::Render()
{
}

void CWorldController::SetCamera(unsigned int id)
{
	/* Read file */
...
void CWorldController::HandleAction(float elapsedMs)
{
}
