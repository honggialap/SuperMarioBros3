...
#define SPR_GREEN_PIPE_DOWN			1002
#define SPR_BLACK_PIPE_UP			2001
#define SPR_BLACK_PIPE_DOWN			2002
#pragma endregion
...
class CEntryPipe : public CGameObject
{
public:
	CEntryPipe(
